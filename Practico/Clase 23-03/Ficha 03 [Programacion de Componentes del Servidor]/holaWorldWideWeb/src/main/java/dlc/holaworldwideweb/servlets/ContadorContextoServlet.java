 ...
 * @author philip
 */
@WebServlet(name = "ContadorContexto", urlPatterns = {"/visitascontexto"})
public class ContadorContextoServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            System.err.println("Clase del ServletContext: " + contexto.getClass().getName());
            if (contexto.getAttribute("contador") != null)
                contador = ((Integer) contexto.getAttribute("contador"));
            else
